...
const DiningSection = () => {
  const restaurants = [
    ...
    { name: "Pool Snacks", type: "Casual Dining", desc: "Freshly prepared poolside snacks and light treats served throughout the day at the infinity pool", hours: "10:00 – 18:00", location: "Infinity Pool Bar", image: diningPoolSnacks },

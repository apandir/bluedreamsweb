      ...
      <div className="section-dark py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-20">
            <div>
              <p className="factsheet-label mb-5">Rejuvenation</p>
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={item.title} className="accent-line-left">
                  <p className="font-display text-xl text-primary-foreground">{item.title}</p>
                  <p className="font-body text-sm opacity-50 mt-2">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>

    ...
    <main>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 px-6 lg:px-10 pb-16 max-w-[1400px] mx-auto w-full">
          ...
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl text-primary-foreground mb-4 text-shadow-hero">{d.title}</h1>
          <p className="font-body text-lg text-primary-foreground/70 max-w-xl text-shadow-sm">{d.heroDesc}</p>
        </div>
      </section>
